  ...
  <div class="side-setting">
    ...
    <setting-item :title="$t('theme.title')">
      ...
      >
        <img-checkbox
          :title="$t('theme.dark')"
          :img="require('@/assets/icons/dark-side-mode.svg')"
          value="dark"
        />
        <img-checkbox
          :title="$t('theme.light')"
          :img="require('@/assets/icons/light-side-mode.svg')"
          value="light"
        />
        <img-checkbox
          :title="$t('theme.night')"
          :img="require('@/assets/icons/pure-dark-mode.svg')"
          value="night"
        />
      </img-checkbox-group>
    </setting-item>
    ...
    <setting-item :title="$t('navigate.title')">
      ...
      >
        ...
        <img-checkbox
          ...
          :img="require('@/assets/icons/top-side-menu.svg')"
          value="head"
        />
        <img-checkbox
          :title="$t('navigate.mix')"
          :img="require('@/assets/icons/mix-menu.svg')"
          value="mix"
        />
      </img-checkbox-group>
    </setting-item>
